---
layout: post
title: Commenting on <font face="Monaco">LiDOs</font>
---
...
The second stage of the *LiDOs* procedure is to identify target surfaces or objects to receive direct illumination. What would be the most suitable metric to use in this case, when designing the targeted effects of light?

Cuttle responded that the "...crucial role of MRSE is that, being the average value of the indirect flux field, it serves as the metric for spatial brightness. Just that, and nothing more". But in doing so, "...provides a basis for exploring responses due to varying the spatial distribution of direct flux...". He did not feel that MRSE would ever "...fully characterise psychological responses in a lit space".
